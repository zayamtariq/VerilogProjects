...
HD_PWD='C:/Users/zayam/fpga/Subtractor/Subtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log subtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source subtractor.tcl -notrace
