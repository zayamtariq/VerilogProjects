...
HD_PWD='C:/Users/zayam/fpga/Subtractor/Subtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source subtractor.tcl
